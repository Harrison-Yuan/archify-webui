...
<p align="center">
  <img src="assets/app-screenshot.svg" alt="Archify AI 应用界面" width="800"/>
  <br/>
  <em>AI 驱动架构图生成器 — 描述你的系统，自动生成专业架构图</em>
</p>

<p align="center">
  <img src="assets/diagram-architecture.svg" alt="架构图示例" width="800"/>
  <br/>
  <em>示例：电商平台微服务架构（API 网关、消息队列、读写分离）</em>
</p>
